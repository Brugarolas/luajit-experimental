...
option(AVX2_OPTIMIZATIONS "Enable AVX2 optimizations" ON)
option(AVX_OPTIMIZATIONS "Enable AVX optimizations" ON)
...
message(STATUS "AVX2 optimizations: ${AVX2_OPTIMIZATIONS}")
message(STATUS "AVX optimizations: ${AVX_OPTIMIZATIONS}")
...
if (USE_FORCE_CLANG)
    ...
    if (AGGRESSIVE_OPTIMIZATION)
        ...
        ## AVX optimizations
        if (AVX2_OPTIMIZATIONS)
            set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -msee -msee2 msee4.3 -mavx -mavx2")
            set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -mavx -mavx2")
        elseif (AVX_OPTIMIZATIONS)
            set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -mavx")
            set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -mavx")
